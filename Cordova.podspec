#
#  Be sure to run `pod spec lint Cordova.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/AnChangSu/JS_OC_Cordova"
  ...
  s.source       = { :git => "https://github.com/AnChangSu/JS_OC_Cordova.git", :tag => "#{s.version}" }
